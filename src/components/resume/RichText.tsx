    ...
    <div className="space-y-2 print:space-y-1">
      {lines.map((line, i) => {
        ...
        if (categoryMatch) {
          ...
          return (
            <div key={i} className="mt-10 mb-5 print:mt-4 print:mb-2 border-l-4 border-blue-600 pl-5 print:pl-3 py-1.5 print:py-1 bg-blue-50/40 rounded-r">
        ...
        if (isPoint) {
          return (
            <div key={i} className="flex items-start gap-4 print:gap-2 text-[19px] print:text-[13px] text-slate-700 leading-[1.7] print:leading-[1.4] pl-3 py-0.5 print:py-0.25 group">
