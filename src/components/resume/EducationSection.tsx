  ...
  return (
    <section className="space-y-12 print:space-y-4">
      ...
      <div className="flex items-center gap-4 mb-10 print:mb-4 border-b border-slate-100 pb-4">
        ...
        <h2 className="text-[18px] print:text-[14px] font-black text-slate-900 uppercase tracking-widest leading-none">
          ...
          return (
            <div key={item.id} className="relative pl-8 print:pl-4 border-l-4 border-slate-100 group print:break-inside-avoid">
              ...
              <div className="space-y-2 print:space-y-1">
                ...
                <h3 className="text-[16px] print:text-[14px] font-black text-slate-900 leading-tight">
                  {eTr.title}
                </h3>
                <div className="text-slate-600 font-bold text-[14px] print:text-[13px]">
                  {eTr.org}
                </div>
              </div>
            </div>
